	        ...
	        <div class="col-md-10 col-md-offset-1">
				...
				<table id="wating" class="table table-striped table-bordered table-hover" search="true">
			      ...
			      <div class="col-md-offset-5">
			      	...
			      	<button type="button"class="btn btn-default" onclick="window.open('<%=projectPath%>/services/RankExportServlet?startDate=<%=start %>&endDate=<%=end %>&state=departLookup&department=<%=request.getParameter("department") %>');">导出</button>
			      </div>						      
				</div>
			</div>
		</div>
