...
<%String projectPath = request.getContextPath(); %>
    ...
    <body>
        <div class="container">
            ...
            <form id="fileupload" action="<%=projectPath%>/services/FileUploadServlet" method="POST" enctype="multipart/form-data">
    ...
    <script src="<%=projectPath%>/assets/js/fileupload/main.js"></script>
</body> 
</html>