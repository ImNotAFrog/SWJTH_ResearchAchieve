									...
									<%}%>
										<div class="form-item">
											...
											<div class="moco-control-input">
	                              				  <input type="text" name="textbookName" id="textbookName" autocomplete="off" class="moco-form-control" value="<%=t.getName() %>" placeholder="请输入教材名称..." <%if(request.getParameter("state").equals("VIEW")){%>readonly="readonly"<%}%>>
										...
										<div class="form-item">
											...
											<div class="moco-control-input">
	                              				  <select class="moco-form-control rlf-select" name="level" hidefocus="true" id="level" data-validate="require-select" <%if(request.getParameter("state").equals("VIEW")){%> onfocus="this.defaultIndex=this.selectedIndex;" onchange="this.selectedIndex=this.defaultIndex;"<%}%>>
                        				...
                        				<div class="form-item" style="margin-top: 12px;">
			                            	...
			                            	<div class="moco-control-input">
				                                <input type="text" name="publishingHouse" id="publishingHouse" autocomplete="off" class="moco-form-control" value="<%=t.getPublishingHouse() %>" placeholder="请输入出版社名称..." <%if(request.getParameter("state").equals("VIEW")){%>readonly="readonly"<%}%>>
				                           		<div class="rlf-tip-wrap errorHint color-red"></div>
                            				</div>
                        				</div>
                        				<div class="form-item" style="margin-top: 12px;">
			                            	...
			                            	<div class="moco-control-input">
				                                <input type="text" name="ISBN" id="ISBN" autocomplete="off" class="moco-form-control" value="<%=t.getISBN() %>" placeholder="请输入书号..." <%if(request.getParameter("state").equals("VIEW")){%>readonly="readonly"<%}%>>
				                           		<div class="rlf-tip-wrap errorHint color-red"></div>
                            				</div>
                        				</div>
                        				<div class="form-item" style="margin-top: 12px;">
		...
		/*校验一些输入表单是否为空*/
  		...
  		if(score.value == ""){
			...
			if(confirm("提交后成果将无法修改，确认通过?")){  
				...
				form.setAttribute("action", "<%=projectPath%>/services/TextbookUpload?next=pass");
				form.removeAttribute("enctype");
				form.removeAttribute("target");
				form.submit();			
			}else{
		...
		/*校验一些输入表单是否为空*/
  		...
  		if(score.value == ""){
			...
			if(confirm("确认将成果设置为不通过?")){  
				...
				var checked = document.getElementById("checked");
				checked.value-=1;
				form.setAttribute("action", "<%=projectPath%>/services/TextbookUpload?next=unpass");
				form.removeAttribute("enctype");
				form.removeAttribute("target");
				form.submit();			
			}else{
